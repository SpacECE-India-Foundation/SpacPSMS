                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="input-group">
                                                            <input id="ctrl-birth_day" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['birth_day']; ?>" type="datetime" name="birth_day" placeholder="Enter Birth Day" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <div class="dropzone required" input="#ctrl-phone" fieldname="phone"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                        <input name="phone" id="ctrl-phone" required="" class="dropzone-input form-control" value="<?php  echo $data['phone']; ?>" type="text"  />
                                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                            <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                        </div>
                                                                    </div>
                                                                    <?php Html :: uploaded_files_list($data['phone'], '#ctrl-phone'); ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
