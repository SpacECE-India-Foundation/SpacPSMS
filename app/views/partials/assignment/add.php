            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="assignment-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("assignment/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-assignment_type" name="assignment_type"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        $value = $option['value'];
                                                        $label = $option['label'];
                                                        $selected = $this->set_field_selected('assignment_type', $value, "");
                                                        ?>
