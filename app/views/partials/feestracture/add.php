            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="feestracture-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("feestracture/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <div class="dropzone required" input="#ctrl-content" fieldname="content"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                        <input name="content" id="ctrl-content" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('content',""); ?>" type="text"  />
