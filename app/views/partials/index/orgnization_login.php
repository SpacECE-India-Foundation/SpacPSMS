    ...
    <div class="row justify-content-center">
        <div class="col-sm-4">
            <div class="my-4 p-3 bg-light">
                ...
                <div>
                    <h4><i class="material-icons">lock_open</i> Orhanisation Login</h4>
                    <hr />
                    <?php 
                    ...
                    <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post">
                        ...
                        <div class="text-center">
                            Don't Have an Account? <a href="<?php print_link("index/orgnization_register") ?>" class="btn btn-success">Register
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm-6">
            <div class="my-6 p-5 bg-light">
                
                <div>
                    <h4><i class="material-icons">lock_open</i> Orginization Login</h4>
                    <hr />
                    <?php 
                        $this :: display_page_errors(); 
                    ?>
                    <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form"    method="post">
                        ...
                        <hr />
                        <div class="text-center">
                            Don't Have an Account? <a href="<?php print_link("index/orgnizationlogin") ?>" class="btn btn-success">Register A Orginization
                            <i class="material-icons">account_box</i></a>
                        </div>
                    </form>
                </div>
