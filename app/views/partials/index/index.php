            ...
            <div class="container">
                <div class="row ">
                    ...
                    <div class="col-md-4 comp-grid">
                        ...
                        <div  class="bg-light p-4 animated fadeIn page-content">
                            <div>
    ...
    <div class="row justify-content-center">
        <div class="col-sm-6">
            <div class="my-5 p-4 bg-light">
                ...
                <div>
                    <h4><i class="material-icons">lock_open</i> Orgnization Login</h4>
                    <hr />
                    <?php 
                        $this :: display_page_errors(); 
                    ?>
                    <form name="loginForm" action="<?php print_link('index/orgnization_login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form"    method="post">
                        <div class="input-group form-group">
                            <input placeholder="Username" name="username"  required="required" class="form-control" type="text"  />
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="form-control-feedback material-icons">account_circle</i></span>
                        ...
                        <hr />
                        <div class="text-center">
                            Don't Have an Account? <a href="<?php print_link("index/orgnization_register") ?>" class="btn btn-success">Register A Orginization
                            <i class="material-icons">account_box</i></a>
                        </div>
                    </form>
                </div>
